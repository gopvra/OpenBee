...
impl AdvancedMovementSystem {
    ...
    fn update_wall_jump(world: &mut World, entity: openclaw_core::ecs::Entity, dt: f32) {
        let on_ground = world
    ...
    fn update_double_jump(world: &mut World, entity: openclaw_core::ecs::Entity, dt: f32) {
        let on_ground = world
            .get_component::<KinematicComponent>(entity)
            .map_or(false, |k| k.on_ground);
    ...
    fn update_dash(world: &mut World, entity: openclaw_core::ecs::Entity, dt: f32) {
        // Read dash state.
    ...
    fn update_wall_slide(world: &mut World, entity: openclaw_core::ecs::Entity, dt: f32) {
        let _ = dt;
        ...
        if ws.is_sliding {
            drop(ws); // release borrow before accessing kinematic
    ...
    fn update_crouch(world: &mut World, entity: openclaw_core::ecs::Entity, dt: f32) {
        let _ = dt;
    ...
    fn update_glide(world: &mut World, entity: openclaw_core::ecs::Entity, dt: f32) {
        let on_ground = world
            .get_component::<KinematicComponent>(entity)
            .map_or(false, |k| k.on_ground);
    ...
    fn update_ladder_climb(world: &mut World, entity: openclaw_core::ecs::Entity, dt: f32) {
        let _ = dt;
    ...
    fn update_swimming(world: &mut World, entity: openclaw_core::ecs::Entity, dt: f32) {
