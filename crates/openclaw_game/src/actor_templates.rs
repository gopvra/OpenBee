...
impl ActorTemplateRegistry {
    ...
    pub fn spawn(
        ...
        world.add_component(
            entity,
            CollisionComponent {
                hit_rect: openclaw_core::render::Rect::new(hr[0], hr[1], hr[2], hr[3]),
                attack_rect: openclaw_core::render::Rect::new(ar[0], ar[1], ar[2], ar[3]),
                clip_rect: openclaw_core::render::Rect::new(0.0, 0.0, 0.0, 0.0),
