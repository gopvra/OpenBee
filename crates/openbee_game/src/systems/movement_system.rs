...
impl MovementSystem {
    fn update_path_elevator(world: &mut World, entity: openbee_core::ecs::Entity, dt: f32) {
    ...
    fn update_predefined_move(world: &mut World, entity: openbee_core::ecs::Entity, dt: f32) {
        let new_offset = {
    ...
    fn update_rope(world: &mut World, entity: openbee_core::ecs::Entity, dt: f32) {
